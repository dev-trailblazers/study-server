...
public class EmailService {
    ...
    public void sendVerificationCode(String email) {
        ...
        saveEmailAuthentication(new EmailAuthentication(email, code));
    }

    public boolean checkVerificationCodeForEmail(EmailAuthenticationDto dto) {
        EmailAuthentication auth = findByEmail(dto.email())
    ...
    public Optional<EmailAuthentication> findByEmail(String email){
        return Optional.of((EmailAuthentication) redisTemplate.opsForValue().get(email));
    }
    ...
    private void saveEmailAuthentication(EmailAuthentication emailAuthentication){
        redisTemplate.opsForValue()
                .set(emailAuthentication.getEmail(), emailAuthentication, 5, TimeUnit.MINUTES);
    }
}
